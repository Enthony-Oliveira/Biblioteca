...
?>
            ...
            <?php foreach ($autores as $autor): ?>
                <div class="card">
                    ...
                    <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #e0e0e0;">
                        <a href="autor_livros.php?id=<?= $autor['id'] ?>" class="btn btn-info btn-small">
                            📚 Ver Livros
                        </a>

                        <a href="autor_editar.php?id=<?= $autor['id'] ?>" class="btn btn-warning btn-small">
                            ✏️ Editar
                        </a>

                        <!-- EXCLUIR SEM RESTRIÇÕES -->
    ...
    <?php else: ?>
        ...
        <div class="alert alert-info">
            ...
            Comece <a href="autor_novo.php" style="color: #0c5460; text-decoration: underline;">
