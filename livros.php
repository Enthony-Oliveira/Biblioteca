...
// ========================================
// CORREÇÃO DO ERRO: DEFINIÇÃO DA CONSTANTE
// ========================================
// O erro era causado pela constante REGISTROS_POR_PAGINA não estar definida.
// **RECOMENDAÇÃO:** Mova esta linha para o arquivo 'config/config.php'
if (!defined('REGISTROS_POR_PAGINA')) {
    define('REGISTROS_POR_PAGINA', 10); // Valor padrão de 10 por página
}
// ========================================
